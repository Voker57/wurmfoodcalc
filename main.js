(function() {
    ...
    let allVeggies = [67, 66, 22, 83, 69, 40, 77, 70, 24, 23, 61];
    ...
    for (let cheese = 25; cheese <= 27; cheese++) {
        ...
        <div class="ingredient-selector">
            <select v-model="ingredientLocal">
                ...
                <optgroup label="Cheese">
                    <option value="27">Buffalo Cheese +87</option>
                    <option value="25">Cheese +84</option>
                    <option value="26">Feta Cheese +86</option>
                </optgroup>
